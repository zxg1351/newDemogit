...
public class SendMessageServiceImpl implements SendMessageService {
    ...
    private static final String accountSid="8a216da85a7d6742015aa2fc5d9b0fd4";
    private static final String accountToken="2be863b1e0ce410d92cb0e42b2847a1c";
    private static final String appId="8a216da85a7d6742015aa2fc5df10fd9";
    @Override
    public ResultInfo sendVerificationCode(String userName) {
        ...
        //*********************************************************************************************************************
        result = restAPI.sendTemplateSMS("15524765003", "1", new String[]{"0624", "7"});
        ...
        if ("000000".equals(result.get("statusCode"))) {
            ...
            resultInfo.setResultMessage("发送失败");
            logger.info("发送失败:"+"错误码=" + result.get("statusCode") + " 错误信息= " + result.get("statusMsg"));
        }
        //发送短信 需要处理
        return resultInfo;
    }
